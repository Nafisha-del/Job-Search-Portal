    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../php/empacc.php">Employees</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../php/jobseekacc.php">Job Seekers</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../php/joblist.php">Jobs List</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="applicants.html">Job Applications</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="deletejobs.html">Delete Jobs</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="deleteaccounts.html">Delete Accounts</a>
                </li>
                <li class="nav-item">
